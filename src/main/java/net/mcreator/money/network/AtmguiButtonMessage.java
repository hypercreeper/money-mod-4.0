...
import net.mcreator.money.procedures.CheckcreditProcedure;
import net.mcreator.money.procedures.AtmguibuttonProcedure;
...
public class AtmguiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			AtmguibuttonProcedure.execute(entity, guistate);
		}
		if (buttonID == 1) {

			CheckcreditProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		MoneyMod.addNetworkMessage(AtmguiButtonMessage.class, AtmguiButtonMessage::buffer, AtmguiButtonMessage::new, AtmguiButtonMessage::handler);
	}
}
