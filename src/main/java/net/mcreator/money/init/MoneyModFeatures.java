...
public class MoneyModFeatures {
	...
	public static final RegistryObject<Feature<?>> SIMPLE_BANK = register("simple_bank", SimpleBankFeature::feature, new FeatureRegistration(
			GenerationStep.Decoration.SURFACE_STRUCTURES, SimpleBankFeature.GENERATE_BIOMES, SimpleBankFeature::placedFeature));
