...
public class ExchangeguiScreen extends AbstractContainerScreen<ExchangeguiMenu> {
	private final static HashMap<String, Object> guistate = ExchangeguiMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("money:textures/screens/exchangegui.png");
