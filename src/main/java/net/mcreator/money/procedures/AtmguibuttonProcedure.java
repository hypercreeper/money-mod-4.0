...
public class AtmguibuttonProcedure {
	public static void execute(Entity entity, HashMap guistate) {
		...
		if (guistate.containsKey("checkbox:withdraw") ? ((Checkbox) guistate.get("checkbox:withdraw")).selected() : false) {
			if ((guistate.containsKey("text:cardpin") ? ((EditBox) guistate.get("text:cardpin")).getValue() : "")
				...
				}.convert(guistate.containsKey("text:amount")
						? ((EditBox) guistate.get("text:amount")).getValue()
							...
							if (entity instanceof Player _player) {
								...
								_setstack.setCount((int) new Object() {
									double convert(String s) {
										...
										(int) ((guistate.containsKey("text:amount") ? ((EditBox) guistate.get("text:amount")).getValue() : "")
												.length() - 1),
										(int) (guistate.containsKey("text:amount") ? ((EditBox) guistate.get("text:amount")).getValue() : "")
												.length())));
				...
				if ((guistate.containsKey("text:cardpin") ? ((EditBox) guistate.get("text:cardpin")).getValue() : "")
					...
					if (MoneyModItems.CASH
						...
						if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current
								&& _current.get() instanceof Map _slots) {
							((Slot) _slots.get(0))
									.remove(((entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr
											&& _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY)).getCount());
							_player.containerMenu.broadcastChanges();
						}
					} else if (MoneyModItems.COIN
							.get() == (entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr
									&& _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY).getItem()) {
						(entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr
								&& _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY).getOrCreateTag()
